...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Accommodation.external_booking_url'
        db.add_column(u'Accommodations_accommodation', 'external_booking_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Accommodation.external_booking_url'
        db.delete_column(u'Accommodations_accommodation', 'external_booking_url')
    ...
    models = {
        u'Accommodations.accommodation': {
            ...
            'external_booking_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
